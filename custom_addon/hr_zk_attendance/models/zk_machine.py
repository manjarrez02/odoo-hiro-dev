                                ...
                                if uid.user_id == each.user_id:
                                    ...
                                    if get_user_id:
                                        ...
                                        if duplicate_atten_ids:
                                            ...
                                            # Asegura que atten_time es datetime
                                            atten_time_filter = each.timestamp
                                            atten_date = atten_time_filter.date()
                                            ...
                                            if each.punch in [5, 15]: #break-out
                                                if len(att_var) == 1:
                                                    if att_var.break_out:
                                                       if fields.Datetime.to_string(att_var.break_out) < atten_time:
                                        ...
                                        print('ddfcd', str(each.status))
                                        print('user', uid.name)
                                        raise UserError(f"No existe un usuario con ID {each.user_id}")
                                else:
                                    pass
                    # zk.enableDevice()
                    conn.disconnect
