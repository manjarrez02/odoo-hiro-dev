...
class POSConfigSummery(models.Model):
	...
	order_summery = fields.Boolean('Order Summary')
	product_summery = fields.Boolean('Product Summary')
	product_categ_summery = fields.Boolean('Product product Summary')
	loc_summery = fields.Boolean('Audit Report')
	payment_summery = fields.Boolean('Payment Summary')
