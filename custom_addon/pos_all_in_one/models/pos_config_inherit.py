...
class PosConfigInherit(models.Model):
	...
	allow_customer_discount = fields.Boolean(string='Allow Customer Discount')
...
class ResConfigSettings(models.TransientModel):
	...
	pos_allow_customer_discount = fields.Boolean(related='pos_config_id.allow_customer_discount',readonly=False)
...
class PosPaymentMethod(models.Model):
    ...
    user_ids = fields.Many2many("res.users",string="Allowed User")
