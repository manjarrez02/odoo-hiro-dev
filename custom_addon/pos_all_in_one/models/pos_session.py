...
class POSSession(models.Model):
	...
	def _loader_params_res_partner(self):
		...
		fields = res.get('search_params').get('fields')
		fields.extend(['loyalty_points1','loyalty_amount','customer_discount','bi_total_credit_amount','bi_not_allow_partial_payment','allow_over_limit','limit_credit'])
		res['search_params']['fields'] = fields
		return res
	...
	def load_pos_data(self):
		...
		users_data1 = self._get_pos_ui_bi_pos_res_users(self._loader_params_bi_pos_res_users())
		loaded_data['users1'] = users_data1

		return loaded_data

	def _get_pos_ui_bi_pos_res_users(self, params):
		users = self.env['res.users'].search_read(**params['search_params'])
		return users


	def _loader_params_bi_pos_res_users(self):
		return {
			'search_params': {
				'domain': [['allow_customer_limit_exceeded','=',True]],
				'fields': ['name','id','add_pin','allow_customer_limit_exceeded'],
			},
		}
	...
	def _loader_params_res_users(self):
		...
		result['search_params']['fields'].extend(['name','id','company_id','lang','is_allow_numpad','is_allow_payments',
				'is_allow_discount','is_allow_qty','is_edit_price','is_allow_remove_orderline','is_allow_customer_selection',
				'is_allow_plus_minus_button','is_allow_refund', 'is_allow_info', 'is_allow_customer_note',
				'is_allow_quotation_order', 'is_allow_sales_order', 'is_allow_coupon','allow_configs','allow_customer_limit_exceeded','add_pin',
				'is_allow_payment_action', 'is_allow_order_summery', 'is_allow_product_summery', 'is_allow_product_categ_summery', 
				'is_allow_loc_summery', 'is_allow_payment_summery', 'is_allow_internal_transfer','is_allow_invoice','is_allow_products','is_allow_find_order',
				'is_allow_draft_order','is_allow_sale_orders','is_allow_orders','is_allow_return_order_barcode','is_allow_enter_code','is_allow_reset_programs','is_allow_reward'])
		return result
	...
	def _loader_params_hr_employee(self):
		...
		result['search_params']['fields'].extend(['is_allow_numpad','is_allow_payments','is_allow_discount','is_allow_qty',
			...
			'is_allow_refund', 'is_allow_info', 'is_allow_customer_note','is_allow_quotation_order', 'is_allow_sales_order', 'is_allow_coupon',
			 'is_allow_payment_action', 'is_allow_order_summery', 'is_allow_product_summery', 'is_allow_product_categ_summery', 
				'is_allow_loc_summery', 'is_allow_payment_summery','is_allow_internal_transfer','is_allow_invoice','is_allow_products','is_allow_find_order',
				'is_allow_draft_order','is_allow_sale_orders','is_allow_orders','is_allow_return_order_barcode','is_allow_enter_code','is_allow_reset_programs','is_allow_reward'])
		return result
	...
	def _loader_params_pos_payment_method(self):
		...
		result['search_params']['fields'].extend(['user_ids'])
		return result