odoo.define('pos_orders_all.ReturnOrderButton', function(require) {
	...
	ProductScreen.addControlButton({
		...
		condition: function() {
			if(!this.env.pos.config.module_pos_hr && this.env.pos.user.is_allow_return_order_barcode){
			...
			if(this.env.pos.config.module_pos_hr && this.env.pos.cashier.is_allow_return_order_barcode){
				if(this.env.pos.config.show_order){
					return true
				}else{
					return true
