odoo.define('viin_web_map.test_utils', function (require) {
"use strict";
	...
	var testUtilsCreate = require('viin_web_map.test_utils_create');
	var testUtils = require('web.test_utils');

	testUtils.createViinMapView = testUtilsCreate.createViinMapView;
	return testUtils;
