   ...
   Odoo point of sales invoice auto check auto invoice check in point of sales auto invoice check POS
    ...
    'assets': {
        'point_of_sale.assets': [
				...
				"pos_orders_all/static/src/js/Popups/BiWarningPopup.js",
				...
				# # Screens
				# # Base
				"pos_orders_all/static/src/js/Screens/Base/PartnerListScreen.js",
				"pos_orders_all/static/src/js/Screens/Base/OrderWidget.js",
				"pos_orders_all/static/src/js/Screens/Base/OrderDetails.js",
            	...
            	'pos_orders_all/static/src/xml/item_count.xml',
            	'pos_orders_all/static/src/xml/pos_orders_list.xml',
            	'pos_orders_all/static/src/xml/reorder_reprint_return.xml',
            	'pos_orders_all/static/src/xml/sale_orders.xml',
            	'pos_orders_all/static/src/xml/pos_stock.xml',
            	'pos_orders_all/static/src/xml/gift_coupon_voucher.xml',
            	'pos_orders_all/static/src/xml/pos_discount.xml',
            	'pos_orders_all/static/src/xml/pos_bag_charges.xml',
        ],
