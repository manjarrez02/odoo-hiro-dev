...

{
   ...
   User can add multiple barcodes to product and can find product useing any of barcode added to product on point of sale, User can also search product using multiple barcodes on product search view and also on sale, purchase, customer invoice, vendor bill, delivery order, and receipt.
    ...
    """,
    "author": "BrowseInfo",
    "website" : "https://www.browseinfo.com/demo-request?app=bi_multi_barcode_for_pos&version=16&edition=Community",
    "price": 10,
    "currency": 'EUR',
    ...
    "auto_install": False,
    "installable": True,
    "live_test_url":'https://www.browseinfo.com/demo-request?app=bi_multi_barcode_for_pos&version=16&edition=Community',
